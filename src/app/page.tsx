...
import TimelineSection from '@/components/blocks/home/timeline-section'
import ContactSection from '@/components/blocks/home/contact-section'
import { generateMetadata as generateSEOMetadata } from '@/lib/seo'

export const metadata: Metadata = generateSEOMetadata({
  description:
    'Muhammad Refansa Ali Muzky - A passionate Software Developer from Jakarta, Indonesia. Supporter of Open Source Software Movement.',
  tags: [
